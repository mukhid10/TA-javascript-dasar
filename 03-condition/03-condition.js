...
const celciusKeKelvin = temperature + 273.15;
const celciusKeFahrenheit = (temperature * 9/5) + 32;
const celciusKeCelcius = temperature;
switch (unit) {
  /// EDIT HERE
  case "K" : console.log(celciusKeKelvin);
  break;
  case "F" : console.log(celciusKeFahrenheit);
  break;
  case "C" : console.log(celciusKeCelcius);
  break;
